const id = "Adi Iyer.md";
						...
						const data = {title:"Adi Iyer",author:"Sam Wu",tags:["California","Poli Sci","Journalism","Asian"],description:"In a competitive Asian community, Adi was labeled a slacker, until a near-death experience ignited change.",pubDate:new Date(1708717200000),imgUrl:
						new Proxy({"src":"/_astro/Adi_Iyer.s8QLnMF1.JPG","width":2832,"height":4240,"format":"jpg","orientation":1,"fsPath":"/Users/samuelwu/Desktop/Senior/Spring/Stories Within /storieswith.in/src/assets/Adi_Iyer.JPG"}, {
					...
					,draft:false};
						const _internal = {
							type: 'content',
							filePath: "/Users/samuelwu/Desktop/Senior/Spring/Stories Within /storieswith.in/src/content/blog/Adi Iyer.md",
