...
var T = (t) => {
  switch (t) {
    case "pseudo-element":
    case "pseudo-class":
      return new RegExp(w2[t].source.replace("(?<argument>¶*)", "(?<argument>.*)"), "gu");
    default:
      return w2[t];
  }
};
...
function U(t, n = w2) {
  ...
  t = (t = t.replace(P2, (o2, i) => (e.push({ value: o2, offset: i }), "".repeat(o2.length)))).replace($, (o2, i, c, a) => (e.push({ value: o2, offset: a }), `${i}${"".repeat(c.length)}${i}`));
  {
    ...
    for (; (o2 = t.indexOf("(", i)) > -1; ) {
      let c = M(t, o2);
      e.push({ value: c, offset: o2 }), t = `${t.substring(0, o2)}(${"¶".repeat(c.length - 2)})${t.substring(o2 + c.length)}`, i = o2 + c.length;
    }
  }
